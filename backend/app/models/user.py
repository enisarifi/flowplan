...
class UserPreferences(Base):
    ...
    blocked_hours_start: Mapped[str] = mapped_column(String(5), nullable=False, default="23:00")
    blocked_hours_end: Mapped[str] = mapped_column(String(5), nullable=False, default="07:00")
    max_sessions_per_day: Mapped[int] = mapped_column(Integer, nullable=False, default=8)
    min_break_between_min: Mapped[int] = mapped_column(Integer, nullable=False, default=10)
    pomodoro_work_min: Mapped[int] = mapped_column(Integer, nullable=False, default=25)
    pomodoro_break_min: Mapped[int] = mapped_column(Integer, nullable=False, default=5)
    sound_enabled: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True)
    calendar_default_view: Mapped[str] = mapped_column(String(20), nullable=False, default="timeGridWeek")
